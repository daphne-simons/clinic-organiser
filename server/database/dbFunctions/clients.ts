...
export async function addClientFromAppointment(firstName: string, lastName: string): Promise<void> {
  await pool.query(
...
export async function addClient(firstName: string, lastName: string, dob: string, mobile: string, email: string, customFields: CustomFields): Promise<void> {
  await pool.query(
